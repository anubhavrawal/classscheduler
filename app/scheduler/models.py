...
class Semester(models.Model):
    ...
    link1 = models.CharField(max_length=2, blank= True)
    link2 = models.CharField(max_length=2, blank= True)
    schedule_type = models.CharField(max_length=2)
    reserved = models.CharField(max_length=1, blank=True)
    ...
    spec_appr = models.CharField(max_length=5, blank=True)
    ...
    site_code = models.CharField(max_length=5, blank= True)
